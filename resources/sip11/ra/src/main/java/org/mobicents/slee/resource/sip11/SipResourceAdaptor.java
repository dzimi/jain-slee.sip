...
public class SipResourceAdaptor implements SipListenerExt, FaultTolerantResourceAdaptor<SipActivityHandle, String> {
    ...
    private SipResourceAdaptorUsageParameters usageParams;
    /**
     *
     */
    ...
    public void processRequest(RequestEvent req) {
        ...
        org.mobicents.slee.resource.sip11.Utils.incrementRequestUsageParameters(req.getRequest(), usageParams);
    ...
    /**
     * Retrieves the wrapper associated with a dialog, recreating if needed in a
     * cluster env.
     *
     * @param d
     * @return
    ...
    /**
     * Retrieves the wrapper associated with a tx, recreating if needed in a
     * cluster env.
     *
     * @param t
     * @return
    ...
    public void processResponse(ResponseEvent responseEvent) {
        ...
        org.mobicents.slee.resource.sip11.Utils.incrementResponseUsageParameters(responseEvent.getResponse(), usageParams);
...
// *************** Event Life cycle
    ...
    public void raActive() {
        ...
        try {
            ...
            properties.setProperty(ClusteredSipStack.CACHE_CLASS_NAME_PROPERTY, SipResourceAdaptorMobicentsSipCache.class
                    .getName());
            this.sipFactory = SipFactory.getInstance();

            this.sipFactory.setPathName(
                    "org.mobicents.ha");
    ...
    public void setResourceAdaptorContext(ResourceAdaptorContext raContext) {
        ...
        this.usageParams = (SipResourceAdaptorUsageParameters) raContext.getDefaultUsageParameterSet();
    }
    ...
    public SipResourceAdaptorUsageParameters getUsageParams() {
        return usageParams;
    }
